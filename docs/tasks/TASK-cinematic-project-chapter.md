...
- Render the route as one explicit high-contrast Newsprint-white dashed line with short strokes and clear gaps; do not use a solid line, dot-like spacing, or a foreground token that can resolve to black over the dark atmosphere.
...
- [ ] Dashed route remains visibly white over both black atmosphere and project imagery without reading as dots or a solid line
