...
- Render the route as one explicit high-contrast continuous Newsprint-white line; do not inherit a foreground token that can resolve to black over the dark atmosphere.
...
- [ ] Continuous route line remains visibly white over both black atmosphere and project imagery
